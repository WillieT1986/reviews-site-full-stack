...
public class ReviewsPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// reviewRepo.save(new Review("Anime Two", "imageUrl", "Description2", tag1,
		// tag2, tag3, tag7, tag10, tag16));
		// reviewRepo.save(new Review("Anime Three", "imageUrl", "Description3", tag1,
		// tag2, tag3, tag5, tag7, tag10,
		// tag11, tag16));
		// reviewRepo.save(new Review("Anime Four", "imageUrl", "Description4", tag1,
		// tag2, tag7, tag12));
		// reviewRepo.save(new Review("Anime Five", "imageUrl", "Description5", tag1,
		// tag2, tag7, tag8, tag10));
		// reviewRepo.save(new Review("Anime Six", "imageUrl", "Description6", tag1,
		// tag5, tag9, tag11, tag13, tag14));
		// reviewRepo.save(new Review("Anime Seven", "imageUrl", "Description7", tag6,
		// tag15, tag16));

		// categoryRepo.save(new Category("Anime", "Description of Anime Goes
		// Here..."));
	}
